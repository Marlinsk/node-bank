  ...
  inquirer
    ...
    .then((answer) => {
      ...
      if (fs.existsSync(`accounts/${accountName}.json`)) {
        console.log(
          chalk.backgroundColorNames.black(
...
function checkAccount(accountName) {
  if (!fs.existsSync(`accounts/${accountName}.json`)) {
    console.log(
      chalk.backgroundColorNames.black(
        "Esta conta não existe, digite o nome correto!"
      )
    );
    return false;
  }
...
function removeAmount(accountName, amount) {
  ...
  console.log(chalk.green(`Saque de R$${amount} realizado com sucesso da sua conta!`))
  operation()
}